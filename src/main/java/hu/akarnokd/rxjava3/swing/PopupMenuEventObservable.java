...
final class PopupMenuEventObservable extends Observable<PopupMenuEvent> {
    ...
    PopupMenuEventObservable(JComboBox<?> widget) {
        this.widget = widget;
    }
    ...
    static final class PopupMenuEventConsumer extends AbstractEventConsumer<PopupMenuEvent, JComboBox<?>>
    implements PopupMenuListener {

        private static final long serialVersionUID = -3605206827474016488L;

        PopupMenuEventConsumer(Observer<? super PopupMenuEvent> actual, JComboBox<?> widget) {
            super(actual, widget);
        }

        @Override
        protected void onDispose(JComboBox<?> w) {
