...
final class ChangeEventProgressBarObservable extends Observable<ChangeEvent> {
    ...
    ChangeEventProgressBarObservable(JProgressBar widget) {
        this.widget = widget;
    }
    ...
    static final class ChangeEventConsumer extends AbstractEventConsumer<ChangeEvent, JProgressBar>
    implements ChangeListener {

        private static final long serialVersionUID = -3605206827474016488L;

        ChangeEventConsumer(Observer<? super ChangeEvent> actual, JProgressBar widget) {
            super(actual, widget);
        }

        @Override
        protected void onDispose(JProgressBar w) {
