...
final class MenuKeyEventPopupObservable extends Observable<MenuKeyEvent> {
    ...
    MenuKeyEventPopupObservable(JPopupMenu widget) {
        this.widget = widget;
    }
    ...
    static final class MenuKeyEventConsumer extends AbstractEventConsumer<MenuKeyEvent, JPopupMenu>
    implements MenuKeyListener {

        private static final long serialVersionUID = -3605206827474016488L;

        MenuKeyEventConsumer(Observer<? super MenuKeyEvent> actual, JPopupMenu widget) {
            super(actual, widget);
        }
