...
final class ListSelectionEventModelObservable extends Observable<ListSelectionEvent> {
    ...
    ListSelectionEventModelObservable(ListSelectionModel widget) {
        this.widget = widget;
    }
    ...
    static final class ListSelectionEventConsumer extends AbstractEventConsumer<ListSelectionEvent, ListSelectionModel>
    implements ListSelectionListener {

        private static final long serialVersionUID = -3605206827474016488L;

        ListSelectionEventConsumer(Observer<? super ListSelectionEvent> actual, ListSelectionModel widget) {
            super(actual, widget);
        }

        @Override
        protected void onDispose(ListSelectionModel w) {
