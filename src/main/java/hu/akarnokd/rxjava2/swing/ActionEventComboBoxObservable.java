...
final class ActionEventComboBoxObservable extends Observable<ActionEvent> {
    ...
    ActionEventComboBoxObservable(JComboBox<?> widget) {
        this.widget = widget;
    }
    ...
    static final class ActionEventConsumer extends AbstractEventConsumer<ActionEvent, JComboBox<?>>
    implements ActionListener {

        private static final long serialVersionUID = -3605206827474016488L;

        ActionEventConsumer(Observer<? super ActionEvent> actual, JComboBox<?> widget) {
            super(actual, widget);
        }
        ...
        @Override
        protected void onDispose(JComboBox<?> component) {
